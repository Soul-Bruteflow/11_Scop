...
# define TEX_COUNT		10
# define WINNAME		"scop"
# define VERT_PATH		"./res/shaders/shader_vertex.glsl"
# define FRAG_PATH		"./res/shaders/shader_fragment.glsl"
# define TGA_PATH_1		"./res/textures/texture_1.tga"
# define TGA_PATH_2		"./res/textures/texture_2.tga"
# define TGA_PATH_3		"./res/textures/texture_3.tga"
# define TGA_PATH_4		"./res/textures/texture_4.tga"
# define TGA_PATH_5		"./res/textures/texture_5.tga"
# define TGA_PATH_6		"./res/textures/texture_6.tga"
# define TGA_PATH_7		"./res/textures/texture_7.tga"
# define TGA_PATH_8		"./res/textures/texture_8.tga"
# define TGA_PATH_9		"./res/textures/texture_9.tga"
# define TGA_PATH_10	"./res/textures/texture_10.tga"
...
typedef struct			s_scop
{
	...
	const char			*vertex_shdr_src;
	const char			*fragment_shdr_src;
	unsigned int		vao;
